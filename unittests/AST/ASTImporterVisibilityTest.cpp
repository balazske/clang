...
auto *ExternFT = "template <class> void f();";
auto *StaticFT = "template <class> static void f();";
auto *AnonFT = "namespace { template <class> void f(); }";
// VarDecl:
auto *ExternV = "extern int v;";
auto *StaticV = "static int v;";
auto *AnonV = "namespace { extern int v; }";
// VarTemplateDecl:
auto *ExternVT = "template <class> extern int v;";
auto *StaticVT = "template <class> static int v;";
auto *AnonVT = "namespace { template <class> extern int v; }";
// CXXRecordDecl:
auto *ExternC = "class X;";
auto *AnonC = "namespace { class X; }";
// ClassTemplateDecl:
auto *ExternCT = "template <class> class X;";
auto *AnonCT = "namespace { template <class> class X; }";
// EnumDecl:
auto *ExternE = "enum E {};";
