...
TEST_P(ASTImporterOptionSpecificTestBase, ImportRecordDeclInFuncParams2) {
  // This construct is not supported by ASTImporter.
  Decl *FromTU = getTuDecl(
      "int declToImport(struct data_t{int a;int b;} ***d){ return 0; }",
      Lang_C,
...
TEST_P(ASTImporterOptionSpecificTestBase, ImportRecordDeclInFuncParamsFromMacro) {
  // This construct is not supported by ASTImporter.
  Decl *FromTU = getTuDecl(
...
TEST_P(ASTImporterOptionSpecificTestBase, ImportOfTemplatedDeclOfClassTemplateDecl) {
...
TEST_P(ASTImporterOptionSpecificTestBase, ImportFunctionWithBackReferringParameter) {
  Decl *From, *To;
...
TEST_P(ASTImporterOptionSpecificTestBase, ImportOfRecursiveFriendClass) {
  Decl *FromTu = getTuDecl(
      R"(
      class declToImport {
...
TEST_P(ASTImporterOptionSpecificTestBase, ImportOfRecursiveFriendClassTemplate) {
  Decl *FromTu = getTuDecl(
      R"(
...
struct ImportFunctionTemplateSpecializations : ASTImporterOptionSpecificTestBase {};
...
TEST_P(ASTImporterOptionSpecificTestBase, OmitVAListTag) {
  Decl *From, *To;
  std::tie(From, To) =
...
TEST_P(ASTImporterOptionSpecificTestBase, ProperPrevDeclForClassTemplateDecls) {
...
TEST_P(ASTImporterOptionSpecificTestBase, TypeForDeclShouldBeSet) {
...
TEST_P(ASTImporterOptionSpecificTestBase,
       DeclsFromFriendsShouldBeInRedeclChains2) {
  Decl *From, *To;
  std::tie(From, To) =
...
TEST_P(ASTImporterOptionSpecificTestBase, ImportOfDeclAfterFwdDecl) {
  Decl *ToD1;
  {
    Decl *FromTU = getTuDecl(
        R"(
...
class CheckODRAtImport : public ASTImporterOptionSpecificTestBase {};
